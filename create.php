<?php
    ...
    if ($_SERVER['REQUEST_METHOD']=='POST') {
        ...
        do {
            ...
            // Input data mahasiswa baru ke database
            $sql = "INSERT INTO tas_php_table(nim, nama_lengkap, kota_asal, tanggal_lahir, nama_orang_tua, alamat_orang_tua, kode_pos, nomor_telepon, status_mhs, dosen_wali)"."VALUES ('$nim', '$nama_lengkap', '$kota_asal', '$tanggal_lahir', '$nama_orang_tua', '$alamat_orang_tua', '$kode_pos', '$nomor_telepon', '$status_mhs', '$dosen_wali')";
            ...
            $successMessage = "Tambah berhasil!";
...
<html lang="en">
    ...
    <body class="monofont bg-dark text-white">
        <div class="container my-2 py-2">
            <h4 class="text-center pt-2">Tambah Mahasiswa</h4>
            <hr>
            <?php
